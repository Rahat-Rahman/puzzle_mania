...
public class puzzleDesignHard1 extends JFrame{
   ...
   private  ChooseHardFrame parentframehard1;
	
	public puzzleDesignHard1(ChooseHardFrame framehard)
	{
		parentframehard1=framehard;
		this.setLayout(null);
	...
	private void AddPanelRightComponent() {
		...
		btnBack.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e) {
				setVisible(false);
				parentframehard1.setVisible(true);
...
private void showHardFrame(){
		...
		Preview e1= new Preview(null,this);
		e1.setVisible(true);
		//setVisible(false);
