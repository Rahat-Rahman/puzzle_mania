...
public class puzzleDesignEasy1g extends JFrame{
	...
	private  levelViewer2 parentframeeasy;
	
	public puzzleDesignEasy1g(levelViewer2 frameeasy)
	{
	...
	private void showEasyFrame(){
		...
		PreviewForGuest e3= new PreviewForGuest(this,null);
		e3.setVisible(true);
		//setVisible(false);
