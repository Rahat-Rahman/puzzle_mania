...
import DAOLayer.HighScoreDAO;
import DAOLayer.UpdateDAO;
...
public class puzzleDesignEasy1 extends JFrame{
	...
	public puzzleDesignEasy1(ChooseEasyFrame frameeasy)
	{
	...
	private void showEasyFrame(){
		...
		Preview e1= new Preview(this,null);
		e1.setVisible(true);
		//setVisible(false);
	...
	private void Check()
	{
		...
		{
			if(!imgs[i].equals(RandomImagePosition.get(i))){
				break;
			}
		}
		...
		if(i==8)
		{
			...
			//user=scoredao.GetById(LoginHelper.loginUser.getId());
			setVisible(false);
			parentframeeasy.setVisible(true);
