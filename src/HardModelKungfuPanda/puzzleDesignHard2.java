...
import GuiLayer.ChooseHardFrame;
import GuiLayer.Preview;
import GuiLayer.PreviewE2;


public class puzzleDesignHard2 extends JFrame{
	...
	private  ChooseHardFrame parentframehard2;
	
	public puzzleDesignHard2(ChooseHardFrame parenthard)
	{
		parentframehard2=parenthard;
		this.setLayout(null);
	...
	private void AddPanelRightComponent() {
		...
		btnBack.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e) {
				setVisible(false);
				parentframehard2.setVisible(true);
...
private void showHardFrame(){
		...
		PreviewE2 e2= new PreviewE2(null,this);
		e2.setVisible(true);
		//setVisible(false);
